...
public class UAWBlock implements ContentList {
    ...
    public void load () {
        ...
        sparkler = new StaticItemTurret("sparkler") {{
            ...
            inaccuracy = 180f;
            shots = 3;
            shootEffect = new MultiEffect(UAWFxStatic.crossShoot, Fx.flakExplosionBig);
            smokeEffect = new MultiEffect(Fx.smokeCloud, Fx.smeltsmoke);
            shootSound = UAWSounds.MissileLaunch1;
            ammoPerShot = 15;
            itemCapacity = 150;
            ammo(
                    Items.blastCompound, new CruiseMissileBulletType(1.4f, 175) {{
                        size = 25;
                        homingRange = range + 16;
                    ...
                    UAWItems.titaniumCarbide, new CruiseMissileBulletType(1.8f, 250) {{
                        size = 25;
                    ...
                    UAWItems.cryogel, new CruiseMissileBulletType(1.4f, 200) {{
                        size = 25;
                        homingRange = range + 16;
                        frontColor = UAWPal.cryoFront;
                        backColor = UAWPal.cryoBack;
                    ...
                    Items.pyratite, new CruiseMissileBulletType(1.4f, 200) {{
                        size = 25;
                        homingRange = range + 16;
                        frontColor = UAWPal.incendFront;
                        backColor = UAWPal.incendBack;
                    ...
                    Items.surgeAlloy, new CruiseMissileBulletType(1.4f, 300) {{
                        size = 25;
                        homingRange = range + 16;
                        frontColor = UAWPal.surgeFront;
                        backColor = UAWPal.surgeBack;
        ...
        sunspot = new StaticItemTurret("sunspot") {{
            requirements(Category.turret, with(
                    Items.graphite, 500,
                    Items.titanium, 450,
                    Items.thorium, 300,
            ...
            shootSound = UAWSounds.MissileLaunch1;
            ammo(
                    Items.blastCompound, new CruiseMissileBulletType(1.4f, 225) {{
                        homingRange = range + 16;
                        hitEffect = new MultiEffect(UAWFxDynamic.crossBlast(backColor, splashDamageRadius), Fx.blastExplosion, Fx.blockExplosionSmoke);
                        status = StatusEffects.blasted;
                    }},
                    UAWItems.titaniumCarbide, new CruiseMissileBulletType(1.8f, 325) {{
                        splashDamageRadius = 3 * tilesize;
                        homingRange = range + 16;
                        hitEffect = new MultiEffect(Fx.hitFuse, Fx.blastExplosion, Fx.smokeCloud, Fx.shootLiquid);
                        hitSound = Sounds.plasmaboom;
                    ...
                    Items.surgeAlloy, new CruiseMissileBulletType(1.4f, 350) {{
                        homingRange = range + 16;
                        frontColor = UAWPal.surgeFront;
                        backColor = UAWPal.surgeBack;
                        hitEffect = new MultiEffect(UAWFxDynamic.crossBlast(frontColor, splashDamageRadius), Fx.blastExplosion, Fx.blockExplosionSmoke);
        ...
        multiplicativePetroleumReconstructor = new Reconstructor("multiplicative-petroleum-reconstructor") {{
            ...
            size = 5;
            consumes.power(4.5f);
            consumes.items(with(Items.silicon, 120, Items.titanium, 100, Items.plastanium, 60));
