...
public class UAWBlock implements ContentList {
    ...
    public void load() {
        ...
        quadra = new DynamicReloadTurret("quadra") {{
            ...
            ammo(
                    Items.copper, new StandardBulletType(4f, 9) {{
                        height = 14f;
                        width = height / 1.8f;
                    ...
                    Items.graphite, new StandardBulletType(3.5f, 18) {{
                        height = 18f;
                        width = height / 1.8f;
                        knockback = 0.15f;
                    ...
                    Items.pyratite, new StandardBulletType(4f, 12f) {{
                        height = 18f;
                        width = height / 1.8f;
                    ...
                    Items.titanium, new StandardBulletType(12f, 10f) {{
                        height = 30f;
                        width = 10f;
                        armorIgnoreScl = 0.2f;
        ...
        spitfire = new DynamicReloadTurret("spitfire") {{
            ...
            ammo(
                    ...
                    UAWItems.titaniumCarbide, new StandardBulletType(12, 22) {{
                        height = 30;
                        width = 8;
        ...
        solo = new CustomStatItemTurret("solo") {{
            ...
            ammoPerShot = 2;
            ammo(
                    Items.copper, new StandardBulletType(10f, 55f) {{
                        hitSize = 5;
                        height = 30f;
                        width = 10f;
                    ...
                    Items.graphite, new StandardBulletType(8f, 90) {{
                        hitSize = 5;
                        height = 25f;
                        width = 15f;
                        shootEffect = new MultiEffect(Fx.shootBig2, Fx.shootPyraFlame);
                    ...
                    Items.silicon, new StandardBulletType(10f, 55f) {{
                        hitSize = 5;
                        height = 30f;
                        width = 10f;
                        homingPower = 0.16f;
                    ...
                    Items.thorium, new StandardBulletType(8f, 80) {{
                        hitSize = 5;
                        height = 30f;
                        width = 16f;
                        shootEffect = new MultiEffect(Fx.shootBig2, Fx.shootPyraFlame);
                    ...
                    Items.titanium, new StandardBulletType(12f, 25f) {{
                        height = 30f;
                        width = 10f;
